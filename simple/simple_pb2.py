...
_SIMPLEMESSAGE = _descriptor.Descriptor(
  name='SimpleMessage',
  full_name='simple.SimpleMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='simple.SimpleMessage.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='is_simple', full_name='simple.SimpleMessage.is_simple', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='simple.SimpleMessage.name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sample_list', full_name='simple.SimpleMessage.sample_list', index=3,
